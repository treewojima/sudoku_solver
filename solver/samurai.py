...
class Samurai(object):
    def __init__(self):
        ...
        box1 = sudokus[1].get_box(0, 2)
        box2 = sudokus[4].get_box(2, 0)
        merge_boxes(box1, box2)

        box1 = sudokus[2].get_box(2, 0)
        box2 = sudokus[4].get_box(0, 2)
        merge_boxes(box1, box2)

        box1 = sudokus[3].get_box(2, 2)
        box2 = sudokus[5].get_box(0, 0)
        merge_boxes(box1, box2)
